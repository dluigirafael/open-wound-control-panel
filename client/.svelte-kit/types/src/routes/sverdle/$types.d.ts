...
export type ActionData = Expand<Kit.AwaitedActions<typeof import('../../../../../node_modules/@sveltejs/kit/src/routes/sverdle/+page.server.js').actions>> | undefined;
export type PageServerData = Expand<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../node_modules/@sveltejs/kit/src/routes/sverdle/+page.server.js').load>>>>;
